...
;; Agenda variables
(setq org-directory "~/Documents/org/org") ; Non-absolute paths for agenda and
...
(setq org-link-abbrev-alist
      '(("family_search" . "https://www.familysearch.org/tree/person/details/%s")
        ("github" . "https://github.com/my-company/my-repo/issues/%s")
        ("crate"  . "https://crates.io/crates/%s")
        ("jira"   . "https://mycompany.atlassian.net/browse/%s")))
  ...
  (setq org-capture-templates
      '(("c" "Default Capture" entry (file "inbox.org")
        ...
        ("n" "Note" entry (file "inbox.org")
         "* %?\n%U\n%i")
	("e" "Event / Appointment" entry (file "inbox.org")
         "* %?\n%^T\n%i")
        ...
        ;; Define a section
        ("w" "Work")
	("wc" "Work note/task" entry (file+headline "work.org" "Tasks")
         "** TODO %?\n%U\n%i")
        ("wn" "Work plain note" entry (file+headline "work.org" "Notes")
         "** %?\n%U\n%i")
	("we" "Event / Appointment" entry (file "work.org")
         "* %?\n%^T\n%i")
        ("wr" "Work task with Reference" entry (file+headline "work.org" "Tasks")
         "** TODO %?\n%U\n%i\n%a")
